...
<head>
    ...
    <style>
        ...
        .button {
            ...
            margin-right: 550px;
            padding: 30px;
            background-color:rgb(67, 29, 193);
            color: blue;
            border:10px solid BLACK; 
        }

        .button input[type="button"] {
            background-color:rgb(132, 92, 207);
            height: 50px;
            width: 50px;
            margin: 0 2px;
            border: 3px solid rgb(230, 203, 167);
        }
    </style>
</head>
...
<body style="background-color: white;">
    <h1 align="center" style="color: BLACK;">CALCULATOR</h1>
        <h3 align="center" style="color: BLACK;">Senthamizhan(212221040150)</h3>
        <div class="button">
            <center>
...
## OUTPUT:
![alt text](image.png)
![alt text](<Screenshot 2024-05-07 132526.png>)
## RESULT:
